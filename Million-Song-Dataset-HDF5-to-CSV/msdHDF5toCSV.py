...
def main():
    print("in mdain")
    outputFile1 = open('SongCSV2.csv', 'w')
    print("hi")
    csvRowString = ""
    ...
    basedir = "./../datasets/MillionSongSubset/data" # "." As the default means the current directory
    ...
    for root, dirs, files in os.walk(basedir):
        for file in files:
            ...
            if filepath.endswith(".h5"):
                ...
                print("entered for loop%s" % count)

                songH5File = hdf5_getters.open_h5_file_read(filepath)
